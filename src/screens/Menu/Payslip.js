import { View, Text, StyleSheet, ScrollView, Image, Button, PermissionsAndroid, Alert, Linking } from 'react-native'
...
const Payslip = () => {
	...
	const getPayslip = async () => {
		try {
			...
			const result = await httpGet(`${employeeDocumentURl}?employee_id=${21}&company_documents_id=1`);
			console.log("payslip", result);
			setPayslip(result.results);
			console.log(payslip);
	...
	return (
		...
		>
			...
			{/* <Header Title={'Payslip'} icon={require('../../../Assets/imgs/pie-chart.png')} /> */}
			...
			<DocumentModal showDocumentModal={showDocumentModal} headerTitle={"Payslip"} source={docFileURL} setShowDocumentModal={setShowDocumentModal} />
			{/* <DocumentModal showDocumentModal={showDocumentModal} source={item.doc_file} setShowDocumentModal={setShowDocumentModal} /> */}
		</Animatable.View>
	)
}
